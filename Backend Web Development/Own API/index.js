...
app.get("/filter", (req, res) => {
  ...
  const joke = jokes.filter((a) => a.jokeType === types);
  res.json(joke);
  });
...
app.put("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id);
  const jokein = jokes.findIndex((a) => a.id === id );
  const newjoke = {
    id : id,
    jokeText : req.body.jokeText,
    jokeType : req.body.jokeType,
  }
  jokes[jokein] = newjoke;
  res.json(newjoke);
  }); 
...
app.patch("/jokes/:id", (req, res) => {
  const id = parseInt(req.params.id);
  const jokepr = jokes.find((a) => a.id === id );
  const jokein = jokes.findIndex((a) => a.id === id );
  const newjoke = {
    id : id,
    jokeText : req.body.jokeText || jokepr.jokeText,
    jokeType : req.body.jokeType|| jokepr.jokeType,
  }
  jokes[jokein] = newjoke;
  res.json(newjoke);
  }); 
